...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _signInUser(AppUser user) async {
    if (_isBusy) {
      return;
    }
                        ...
                        children: [
                          ...
                          if (_mode == _AuthMode.signIn) ...[
                                ...
                                if (users.isEmpty) {
                                  return Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.stretch,
                                    children: [
                                      const Text('No accounts found yet.'),
                                      const SizedBox(height: 12),
                                      OutlinedButton(
                                        onPressed: _isBusy
                                            ? null
                                      ...
                                      Padding(
                                        ...
                                        child: Material(
                                          ...
                                          child: ListTile(
                                            ...
                                            subtitle: Text(
                                              '${user.authMode.dbValue} · '
                                              '${user.localUuid.substring(0, 8)}',
                                            ),
                                            trailing: TextButton(
                                              onPressed: _isBusy
                                                  ? null
                            ...
                            SwitchListTile.adaptive(
                              ...
                              subtitle:
                                  Text(_isRemote ? 'Enabled' : 'Disabled'),
                              onChanged: _isBusy
                                  ? null
                                  : (value) {
