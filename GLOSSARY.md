...
| + `kProfilePeakTolerance` (15°) | **84°** | High sensitivity, normal reps |
| + warmup multiplier (1.5×) on tolerance | **91.5°** | High sensitivity, first 2 reps of a set |
| + Medium post-pass delta (+12°) | **96°** | Medium sensitivity, normal reps |
| + both (Medium + warmup) | **103.5°** | Medium sensitivity, first 2 reps of a set |
